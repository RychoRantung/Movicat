package com.rychorantung.movicat.adapter;
...
import com.rychorantung.movicat.DetailMovieActivity;
import com.rychorantung.movicat.R;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MovieAdapter.MyViewHolder holder, int position) {
        holder.movTitle.setText(resultList.get(position).getTitle());
        holder.movDesc.setText(resultList.get(position).getOverview());
        holder.movRelease.setText(resultList.get(position).getReleaseDate());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ImageView imgPoster;
        TextView movTitle, movDesc, movRelease, movRating;
        RelativeLayout relativeLayout;
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);

            imgPoster = itemView.findViewById(R.id.imgMov);
            movTitle = itemView.findViewById(R.id.movTitle);
            movDesc = itemView.findViewById(R.id.movDesc);
            movRelease = itemView.findViewById(R.id.movRelease);

            relativeLayout = itemView.findViewById(R.id.layoutMov);
        }
    }
}
